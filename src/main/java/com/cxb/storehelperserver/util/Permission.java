...
public class Permission {
    ...
    static public final int mp_storage_purchase2_apply = 15;
    static public final int mp_storage_loss_apply = 16;
    static public final int mp_storage_return_apply = 17;
    static public final int mp_product_process_apply = 18;
    static public final int mp_product_complete_apply = 19;
    static public final int mp_product_loss_apply = 20;
    static public final int mp_agreement_shipped_apply = 21;
    static public final int mp_agreement_return_apply = 22;
    static public final int mp_cloud_purchase_apply = 23;
    static public final int mp_cloud_return_apply = 24;
    static public final int mp_cloud_sale_apply = 25;
    static public final int mp_cloud_loss_apply = 26;
    ...
    static public final int mp_storage_purchase2_review = 45;
    static public final int mp_storage_loss_review = 46;
    static public final int mp_storage_return_review = 47;
    static public final int mp_product_process_review = 48;
    static public final int mp_product_complete_review = 49;
    static public final int mp_product_loss_review = 50;
    static public final int mp_agreement_shipped_review = 51;
    static public final int mp_agreement_return_review = 52;
    static public final int mp_cloud_purchase_review = 53;
    static public final int mp_cloud_return_review = 54;
    static public final int mp_cloud_sale_review = 55;
    static public final int mp_cloud_loss_review = 56;
