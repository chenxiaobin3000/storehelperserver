...
public class CloudService {
     ...
     * desc: 损耗进货
     */
    public RestResult loss(int id, TCloudOrder order, List<Integer> types, List<Integer> commoditys,
        ...
        ret = createCloudComms(order, types, commoditys, values, prices, comms);
        if (null != ret) {
            return ret;
        }
     ...
     * desc: 原料损耗修改
     */
    public RestResult setCloud(int id, TCloudOrder order, List<Integer> types, List<Integer> commoditys,
                                  List<Integer> values, List<BigDecimal> prices, List<Integer> attrs) {
        val reviews = new ArrayList<Integer>();
        RestResult ret = check(id, order, mp_loss_local_apply, mp_loss_local_review, reviews);
        if (null != ret) {
        ...
        // 已经审核的订单不能修改
        TCloudOrder lossOrder = cloudOrderRepository.find(order.getId());
        if (null == lossOrder) {
    ...
    public RestResult delCloud(int id, int oid) {
    ...
    public RestResult reviewCloud(int id, int oid) {
        // 校验审核人员信息
    ...
    public RestResult revokeCloud(int id, int oid) {
        TCloudOrder order = cloudOrderRepository.find(oid);
        if (null == order) {
     ...
     * desc: 原料退货
     */
    public RestResult returnc(int id, TCloudOrder order, List<Integer> types, List<Integer> commoditys,
                              List<Integer> values, List<BigDecimal> prices, List<Integer> attrs) {
        val reviews = new ArrayList<Integer>();
     ...
     * desc: 原料退货修改
     */
    public RestResult setReturn(int id, TCloudOrder order, List<Integer> types, List<Integer> commoditys,
                                List<Integer> values, List<BigDecimal> prices, List<Integer> attrs) {
        val reviews = new ArrayList<Integer>();
        RestResult ret = check(id, order, mp_loss_cloud_apply, mp_loss_cloud_review, reviews);
        if (null != ret) {
    ...
    private RestResult createCloudComms(TCloudOrder order, List<Integer> types, List<Integer> commoditys,
                                          List<Integer> values, List<BigDecimal> prices, List<TCloudCommodity> list) {
        // 生成损耗单
