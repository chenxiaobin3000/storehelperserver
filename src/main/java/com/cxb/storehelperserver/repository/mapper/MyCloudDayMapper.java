 ...
 */
@Mapper
public interface MyCloudDayMapper {
    @Select({"<script>",
            "select count(t1.id) from t_cloud_day t1 left join t_commodity t2 on t1.cid = t2.id where t1.gid = #{gid}",
    ...
    @Select({"<script>",
            "select count(t1.id) from t_cloud_day t1 left join t_halfgood t2 on t1.cid = t2.id where t1.gid = #{gid}",
    ...
    @Select({"<script>",
            "select count(t1.id) from t_cloud_day t1 left join t_original t2 on t1.cid = t2.id where t1.gid = #{gid}",
    ...
    @Select({"<script>",
            "select count(t1.id) from t_cloud_day t1 left join t_standard t2 on t1.cid = t2.id where t1.gid = #{gid}",
    ...
    @Select({"<script>",
            ...
            "from t_cloud_day t1 left join t_commodity t2 on t1.cid = t2.id where t1.gid = #{gid} and t1.ctype = 1",
    ...
    @Select({"<script>",
            "select t1.id, t1.gid, t1.sid, t1.cid, t1.price, t1.weight, t1.value, t2.code, t2.name, t2.cid as ctid, t2.remark",
            "from t_cloud_day t1 left join t_halfgood t2 on t1.cid = t2.id where t1.gid = #{gid} and t1.ctype = 2",
            "<if test='0 != sid'>and t1.sid = #{sid}</if> and t1.cdate = #{date}",
            "<if test='null != search'>and t2.name like #{search}</if> limit #{offset}, #{limit}",
            "</script>"})
    ...
    @Select({"<script>",
            "select t1.id, t1.gid, t1.sid, t1.cid, t1.price, t1.weight, t1.value, t2.code, t2.name, t2.cid as ctid, t2.remark",
            "from t_cloud_day t1 left join t_original t2 on t1.cid = t2.id where t1.gid = #{gid} and t1.ctype = 3",
            "<if test='0 != sid'>and t1.sid = #{sid}</if> and t1.cdate = #{date}",
            "<if test='null != search'>and t2.name like #{search}</if> limit #{offset}, #{limit}",
            "</script>"})
    ...
    @Select({"<script>",
            "select t1.id, t1.gid, t1.sid, t1.cid, t1.price, t1.weight, t1.value, t2.code, t2.name, t2.cid as ctid, t2.remark",
            "from t_cloud_day t1 left join t_standard t2 on t1.cid = t2.id where t1.gid = #{gid} and t1.ctype = 4",
            "<if test='0 != sid'>and t1.sid = #{sid}</if> and t1.cdate = #{date}",
            "<if test='null != search'>and t2.name like #{search}</if> limit #{offset}, #{limit}",
            "</script>"})
    ...
    @Select({"<script>",
            "select sid as id, sum(weight) as total, cdate from t_cloud_day where gid = #{gid} <if test='0 != sid'>and sid = #{sid}</if>",
